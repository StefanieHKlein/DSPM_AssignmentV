...
I then set up a for loop iterating over all venues on the pages 1-610 (excluding first (no. 0) and last page (no. 611)).
...
I then set up a data frame for the Spanish venues (pages 1-154 (0-153)) which I fill using a for loop.
...
Before I visualize the Spanish venue data, I check the range for longitude and latitude.

...
fullPages <- floor(n / 20)
lastPage <- n - fullPages * 20
n <- totalElements - 20 - 16
...
venue_response_all <- GET("https://app.ticketmaster.com/discovery/v2/venues",
  ...
  venue_data_all[(20 * p - 19):(20 * p), ] <- data.frame(
    ...
    latitude = venue_content_all2$location[2], check.rows = FALSE)
    Sys.sleep(0.2)
}
...
venue_response_all <- GET("https://app.ticketmaster.com/discovery/v2/venues",
  ...
  venue_content_all2 <- venue_content_all[['_embedded']][['venues']]
    ...
    venue_data_all[(20 * p - 19):(20 * p), ] <- cbind(name, city, postalCode, 
                                                      address, url, longitude,
                                                      latitude)
    Sys.sleep(0.2)
}

length(venue_data_all$city)
